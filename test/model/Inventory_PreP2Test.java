...
public class Inventory_PreP2Test {
	...
	public void testGetItemNull() {
		...
		inventory = makeInventory(1);
		assertNull(inventory.getItem(inventory.getSize()));
		assertNull(inventory.getItem(inventory.getSize()-inventory.getSize()-1));
	}
	...
	public void testClearInt() {
		...
		try {
			for (int i=15; i>=0; i-- ) {
				inventory.clear(inventory.getSize() - (i+1));
				assertEquals(i,inventory.getSize());
			}
		} catch (Exception e) {
			fail("Error: excepción "+e.getClass().toString()+" inesperada");
		}
	...
	public void testSetItem() {
		...
		inventory = makeInventory(1);
		try {
			ItemStack it = new ItemStack(Material.APPLE,20);
			try {
				inventory.setItem(4, it);
				inventory.setItem(9, it);
				assertEquals(inventory.getItem(4), inventory.getItem(9));
	...
	public void testSetItemException2() throws BadInventoryPositionException {
		...
		try {
			ItemStack it = new ItemStack(m,15);
