...
public class Location_PreP2Test {
    ...
    public final void testCheckOutOfLimits()
    {
    	...
    	Location loc1 = new Location(world,4.0,Location.UPPER_Y_VALUE,4.0);
    	Location loc2 = new Location(world,-4.0,Location.UPPER_Y_VALUE+1,4.0);
    	Location loc3 = new Location(world, 4.0,Location.UPPER_Y_VALUE,-4.0);
    	Location loc4 = new Location(world,-4.0,Location.UPPER_Y_VALUE,-4.0);
    ...
    public final void testBelowBadLocationException() {
    	...
    	Location loc1 = new Location(world,2.0,0,2.0);
    	try {
			loc1.below();
			fail("No tenia que ocurrir esto");
		} catch (BadLocationException e) {
			//assertEquals(loc1.below().toString(),loc1);
		}
